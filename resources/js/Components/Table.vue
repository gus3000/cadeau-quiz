...
<template>
  <div class="not-prose relative bg-slate-50 rounded-xl overflow-hidden dark:bg-slate-900">
    ...
    <div class="relative rounded-xl overflow-auto">
      <div class="shadow-sm overflow-hidden my-8">
        <table class="border-collapse table-auto w-full text-sm">
          ...
          <tr>
            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">The
